...
def configs():
    ...
    parser.add_argument('--model_name', type=str, default='stau')
    ...
    parser.add_argument('--fvd', type=str, default='False')
    ...
    parser.add_argument('--num_save_samples', type=int, default=624)
    parser.add_argument('--n_gpu', type=int, default=1)
    parser.add_argument('--pretrained_model', type=str, default='checkpoints/mnist/model.ckpt-150000')
